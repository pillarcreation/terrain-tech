...
<td class='field'><input type='text' class='text' id='attachments[[+ID+]][post_title]' name='attachments[[+ID+]][post_title]' value='[+post_title_attr+]'  aria-required='true'  /></td>
		...
		<tr class='post_name form-required'>
			...
			<td class='field'><input type='text' class='text' id='attachments[[+ID+]][post_name]' name='attachments[[+ID+]][post_name]' value='[+post_name_attr+]'  /><p class='help'>[+Must be unique+]</p></td>
		</tr>
		<tr class='image_alt'>
			<th valign='top' scope='row' class='label'><label for='attachments[[+ID+]][image_alt]'><span class='alignleft'>[+ALT Text+]</span><br class='clear' /></label></th>
			<td class='field'><input type='text' class='text' id='attachments[[+ID+]][image_alt]' name='attachments[[+ID+]][image_alt]' value='[+image_alt_attr+]'  /><p class='help'>[+ALT Text Help+]</p></td>
		</tr>
		...
		<tr class='parent_info'>
			...
			<td class='field'><table><tr><td style="width: 50px; vertical-align:top" ><input type='text' class='text' name='attachments[[+ID+]][post_parent]' value='[+post_parent+]' /></td><td><input type='text' class='text' readonly='readonly' name='attachments[[+ID+]][parent_info]' value='[+parent_info+]' /></td></tr><tr><td colspan="2"><p class='help'>[+Parent Info Help+]</p></td></tr></table></td>
		</tr>
		<tr class='menu_order'>
...
[+authors+]
		<tr class='image_url'>
			<th valign='top' scope='row' class='label'><label for='attachments[[+ID+]][image_url]'><span class='alignleft'>[+File URL+]</span><br class='clear' /></label></th>			<td class='field'><input type='text' class='text urlfield' readonly='readonly' name='attachments[[+ID+]][image_url]' value='[+guid_attr+]' /><br /><p class='help'>[+File URL Help+]</p></td>
		</tr>
		<tr class='image_meta'>
